...
// utils/compose-user-name.ts
var composeUserName = (user) => {
  return user.firstName + " " + user.lastName;
};

// utils/is-mobile.ts
var isMobile = (userAgent) => {
...
// utils/get-useragent-specs.ts
var Bowser = __toESM(require("bowser"));
var getUserAgentSpecs = (userAgent) => {
